import numpy as np
from build_simulate_analyse.build_model import setup_model, visualize_simulation
import pandas as pd
...
def test_pos_control_pulsed(plot=True, print_rules=True, print_odes=True):
    ...
    # increase k_prot_deg and k_rna_deg
    ...
    # Setup the model with pulses
    model = setup_model(plasmids, parameters, use_pulses=True, pulse_config=pulse_config)
...
if __name__ == "__main__":
    # model = test_pos_control_constant(plot=True, print_rules=False, print_odes=False)
