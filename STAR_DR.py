...
RNA_regulatory_base_module(RNA_2, RNA_1, k_init_RNA_2_molnum, k_bind_RNA_2_RNA_1_molnum, k_unbind_RNA_2_RNA_1_molnum, k_act_RNA_2_molnum, k_act_reg_RNA_2_RNA_1_molnum, k_stop_RNA_2_molnum, k_stop_reg_RNA_2_RNA_1_molnum, k_deg_RNA_2_molnum)
...
y = ScipyOdeSimulator(model, tspan=t).run(param_values={'RNA_1_0':RNA_1_0_combinations, 'k_act_RNA_2':k_act_RNA_2_combinations}).all
